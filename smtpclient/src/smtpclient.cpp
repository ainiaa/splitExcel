...
QString SmtpClient::getError() {

    static QHash<SmtpClient::SmtpError, QString> errMap;
    if (errMap.size() == 0) {
        errMap.insert(SmtpClient::ConnectionTimeoutError, "SmtpClient::ConnectionTimeoutError");
        errMap.insert(SmtpClient::ResponseTimeoutError, "SmtpClient::ResponseTimeoutError");
...
void SmtpClient::setError(SmtpClient::SmtpError error) {
    this->error = error;
